...
describe("ProfileService shared profile tests", function () {
    ...
    it("should return a shared reference to the profile when getProfile is called", function () {
        ...
        var responder = http.when("GET", "/path/opus/opusId1/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:{profileId:'p1', uuid:'u1', prop:'1'}, opus:{}});
    ...
    it("should return a shared reference to the profile when updateProfile is called", function () {
        ...
        var profile1, profile2;
        http.when("GET", "/path/opus/opusId1/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:{profileId:'p1', uuid:'u1', prop:'1'}, opus:{}});
    ...
    it("should determine other names for the profile by inspecting attributes", function () {
        ...
        var sharedProfile;
        http.when("GET", "/path/opus/opusId1/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:profile});
    ...
    it("should update the shared profile when attributes are updated", function() {
        ...
        http.expectGET("/path/opus/opusId1/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:{profileId:'p1', uuid:'u1', prop:'1', attributes:[attribute]}, opus:{}});
    ...
    it("should update the shared profile when attributes are deleted", function() {
        ...
        http.expectGET("/path/opus/opusId1/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:{profileId:'p1', uuid:'u1', prop:'1', attributes:[]}, opus:{}});
    ...
    it("should not cache profile data from supporting collections", function() {
        ...
        http.when("GET", "/path/opus/opusId2/profile/profileId1/json?countChildrenLimit=11&fullClassification=true").respond({profile:{opusId:"opusId2", profileId:'profileId1'}, opus:{}});
