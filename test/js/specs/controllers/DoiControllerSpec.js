...
describe("DoiController tests", function () {
    ...
    it("when loadPublication is called, it should call profileService.getPulicationFromId", function () {
        ...
        expect(scope.doiCtrl.publications.length).toEqual(3);
