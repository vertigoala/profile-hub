...
class PrivateImageFileSpec extends Specification {
    ...
    def "Private image is saved"() {
        ...
        imageService.uploadImage('/profile-hub', 'collection1', 'profile1', '1', [:], file)
        ...
        assert imageDir.listFiles()[0].getName().equalsIgnoreCase(imageId + '.jpg')
    ...
    LocalImage populateLocalImage(String imageId) {
        ...
        privateImage.setDateCreated(new Date())
