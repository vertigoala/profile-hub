(function() {
    ...
    function MultiMediaController($log, $modal, util, embedService, profileService, messageService) {
        ...
        function showMultimediaDialog(doc) {
            ...
            var dialog = $modal.open({
                templateUrl: util.contextRoot() + "/static/templates/multimediaDialog.html",
                // templateUrl: "multimediaDialog.html",
    ...
    profileEditor.directive('multimedia', ['util', function (util) {
        return {
            ...
            templateUrl: util.contextRoot() + '/static/templates/multimedia.html'
        };
    }]);
    ...
    profileEditor.directive('embed', ['util', function (util) {
        return {
            ...
            bindToController: true,
            replace: true,
            templateUrl: util.contextRoot() + '/static/templates/embed.html'
        };
    }]);
