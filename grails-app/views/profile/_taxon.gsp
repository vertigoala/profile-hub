<div class="panel panel-default" ng-controller="TaxonController as taxonCtrl" ng-init="taxonCtrl.init('${edit}')" ng-cloak ng-show="taxonCtrl.classifications.length > 0">
    <a name="{{profileCtrl.readonly() ? 'view_' : 'edit_'}}taxon"></a>
    <div class="panel-body">
        <div class="col-sm-2"><strong>Taxonomy from {{taxonCtrl.speciesProfile.taxonConcept.infoSourceName}}</strong></div>
